...
function Solution() {
  return (
    <div>
      <SectionHeading 
        title = "解决方案"
        subtitle ='选择我们选择我们选择们选择我们选择我们选择我们的解决方案'
      />
      <div className='grid lg:grid-cols-2 mt-20 gap-20'>
        <div>
          <h3 className='mt-7 text-[32px] font-bold'>强有力的工具</h3>
          <p className='mt-4 mb-8 text-gray-500'>我们提供强大的工具，帮助您实现目标。</p>
          <ul className='grid gap-3'>
            {[1, 2, 3].map((item) => (
              <li className={`p-5 justify-between rounded border border-zinc-100 ${item === 1 && 'bg-zinc-100'}`}
              key={item}
            >
              <p className='text-lg font-bold'>构建简单的生态系统</p>
              <div className='flex justify-center relative'>
                <p className='text-lg leading-7 mt-1'>构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统
                </p>
                  <svg
                    width="38"
                    height="38"
