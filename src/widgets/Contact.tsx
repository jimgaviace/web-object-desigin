...
function Contact() {
  return (
    <div className='bg-black md:w4/5 mx-auto relative overflow-hidden'>
      <div className='w-full py-16 px-12'>
        <h2 className='text-3xl text-white font-bold'>来吧！强化你的公司</h2>
        <p className='text-lg text-white mt-2 mb-6'>来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧来吧</p>
        <div className='flex flex-col md:flex-row items-start gap-4'>
          <input 
            ...
            placeholder='你的邮箱'
          />
          <button className='py-3  px-8 bg-blue-500 text-white text-base font-medium md:ml-2'>立即开始</button>
        </div>
        <p className='text-sm text-zinc-400 mt-3'>7天免费试用，无需付费</p>
      </div>
