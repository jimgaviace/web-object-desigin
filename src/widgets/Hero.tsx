...
function Hero() {
  return (
    <div className='grid justify-items-center gap-8 pb-28 relative'>
      <p className='text-4xl md:text-6xl font-black text-center leading-normal md:leading-normal'>打造一个完整的 React 应用</p>
      <p className='text-xl text-gray-700 md:w-1/2 text-center'>React 是一个用于构建用户界面的 JavaScript 库。</p>
      <div>
